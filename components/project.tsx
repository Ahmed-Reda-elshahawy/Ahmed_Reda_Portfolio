...
export default function Project({ title, description, skills, projectImg, liveDemo, githupLink }: projectProps) {
    return (
        <div className="group bg-zinc-300 dark:bg-zinc-700 shadow-md mb-6 p-6 rounded-lg relative overflow-hidden text-center lg:w-[60rem] lg:h-[28rem] lg:text-start lg:flex md:gap-6">
